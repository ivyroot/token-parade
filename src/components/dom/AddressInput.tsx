...
export const AddressInput = () => {
  ...
  return (
    <div
      className='absolute max-w-lg px-4 py-2 text-sm shadow-xl bg-slate-300 md:text-base bottom-8 left-1/2 text-gray-50 transform -translate-x-1/2'
      style={{
    ...
    >
      <div className='tracking-wider'>
        Enter Address: &nbsp;
        <input type="text" className='p-2 mx-8 text-sm text-slate-800 w-96' placeholder='0x123abc456...' value={addressInput} onChange={(e) => {setAddressInput(e.target.value)}} />
